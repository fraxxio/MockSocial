        ...
        <div className='w-full'>
          <div className='flex justify-between'>
            <div className='flex gap-3'>
              <h1 className='font-semibold leading-none'>Username</h1>
          ...
          <p>
            Some text this is the twweeeet Some text this Some text this is the twweeeet Some text
            this Some text this is the twweeeet Some text this
          </p>
          ...
          <div className='flex justify-between pt-3'>
            ...
            <div className='flex gap-1 items-center'>
              ...
              <p className='text-gray-500 text-sm'>251</p>
            </div>
            <div className='flex gap-1 items-center'>
              <svg viewBox='0 0 24 24' className='fill-gray-500 size-5'>
                <g>
              ...
              <p className='text-gray-500 text-sm'>20k</p>
            </div>
            <div className='flex gap-3'>
              <svg viewBox='0 0 24 24' className='fill-gray-500 size-5'>
                <g>
