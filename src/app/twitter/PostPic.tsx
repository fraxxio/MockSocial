...
const PostPic = () => {
  ...
  return (
    <div className='flex gap-4 border-gray-500 border-opacity-45 border h-fit p-4 w-full'>
      <Avatar>
      ...
      <div className='w-full relative'>
        ...
        <div className='flex justify-between pt-3'>
          <div className='flex gap-1 items-center'>
            ...
            <p className='text-gray-500 text-sm'>{formatData(formData.comments)}</p>
          </div>
          <div className='flex gap-1 items-center'>
            <svg viewBox='0 0 24 24' className='fill-gray-500 size-5'>
              <g>
            ...
            <p className='text-gray-500 text-sm'>{formatData(formData.reposts)}</p>
          </div>
          <div className='flex gap-1 items-center'>
            <svg viewBox='0 0 24 24' className='fill-gray-500 size-5'>
              <g>
            ...
            <p className='text-gray-500 text-sm'>{formatData(formData.likes)}</p>
          </div>
          <div className='flex gap-1 items-center'>
            <svg viewBox='0 0 24 24' className='fill-gray-500 size-5'>
              <g>
            ...
            <p className='text-gray-500 text-sm'>{formatData(formData.views)}</p>
          </div>
          <div className='flex gap-3'>
            <svg viewBox='0 0 24 24' className='fill-gray-500 size-5'>
              <g>
