      ...
      <FormContextProvider>
        <Tabs defaultValue='post' className='w-[400]'>
          ...
          <TabsContent value='post'>
            <div className='grid grid-cols-[40rem_40%] gap-1 items-center justify-between place-content-center max-xl:grid-cols-[40rem] max-xl:justify-around max-xl:gap-4 max-md:grid-cols-1'>
              <PostPic />
              <TwitterPost />
            </div>
          </TabsContent>
